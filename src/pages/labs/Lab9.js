...
import { labData9 } from '../../recources/labData'

import LabDescription from '../../components/LabDescription'
import Calculator from '../../components/Calculator/Calculator'
import LeverBalance from '../../components/tasks/LeverBalance'

export default class Lab9 extends Component {
    render() {
        return (
            <Container >
                <Tab.Container id="ledt-tabs-example" defaultActiveKey="1" >
                    <Row>
                        ...
                        <Col sm={9} className="mt-4">
                            <Tab.Content >
                                <Tab.Pane eventKey="1">
                                    <LabDescription labData={labData9} />
                                </Tab.Pane>
                                <Tab.Pane eventKey="2">
                                    <LeverBalance labData={labData9} />
                                </Tab.Pane>
                                <Tab.Pane eventKey="4">
                                    <Form>
